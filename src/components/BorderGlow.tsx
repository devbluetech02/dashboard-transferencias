...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  return (
    <div
      ...
      className={`relative grid isolate border border-white/10 ${onClick ? "cursor-pointer" : ""} ${className}`}
      style={{
        background: backgroundColor,
        borderRadius: `${borderRadius}px`,
        transform: "translate3d(0, 0, 0.01px)",
        boxShadow:
          "rgba(0,0,0,0.06) 0 1px 2px, rgba(0,0,0,0.06) 0 2px 4px, rgba(0,0,0,0.06) 0 4px 8px",
      }}
    >
      <div
      ...
      <div className="flex flex-col relative overflow-hidden z-[1] w-full">
        {children}
      </div>
    </div>
  );
